...
def startNetwork():
    ...
    #net.addController( 'c0', controller=RemoteController, ip='192.168.56.103', port=6653 )

    c0 = RemoteController('c0', ip='192.168.56.103', port=6653)
    ...
    for i in range(1000):
        ...
        if(x==1 or x==6 or x==7 or x==8 or x==9 ):
            for h in hosts:
                h.cmd('cd /home/mininet/Downloads')
